...
Для вызова Iris используется обычная JWT авторизация по пользователю, либо M2M-авторизация, описанная в разделе [авторизации и создания организаций](./Iris_autorization.md).
